...
if __name__ == "__main__":
    ...
    with open("new_data_anchor.csv", "w") as f:
        writer = csv.writer(f)
    ...
    for root, d_names, files in os.walk(dir_scans):
        ...
        for folder in folder_names:
            ...
            img_path = os.path.join(new_path, "real_image.nrrd")
    ...
    for (image_path, label_path) in zip(all_image_urls, all_mask_urls):
        ...
        # print(image_path)
        # print(subject["mask"][tio.DATA].shape)
    ...
    # I added this
    torch.save(net.state_dict(), "new_data_anchor.pth")
